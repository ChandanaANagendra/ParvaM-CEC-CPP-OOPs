...
class Bike : public Vehicle{  //derived class can access the data and member functions of base class (via public)
    private:
        string brand;
...
int main(){
    ...
    cout << "Enter the Mode of Transport and Brand Name of your bike: ";
